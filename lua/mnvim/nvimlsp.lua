...
local servers = { 'clangd', 'pyright', 'bashls', 'cmake', 'jsonls', 'texlab', 'sumneko_lua', 'vimls', 'lemminx', 'yamlls',
  'rust_analyzer', 'arduino_language_server' }
...
lsp_installer.on_server_ready(function(server)
  ...
  local server_opts = {
    ...
    ["clangd"] = function()
      ...
      default_opts.root_dir = nvim_lsp.util.root_pattern(".git", "compile_commands.json", "compile_flags.txt",
        ".catkin_workspace")
      return default_opts
    end,
  }
