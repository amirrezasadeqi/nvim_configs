...
class cocIncPath(object):
	...
	@pynvim.function('addPathtojson')
	def add_path_to_ccjson(self, path):
	...
	@pynvim.command('IncludePath')
	def includePath(self):
		path = self.get_user_incPath()
		self.add_path_to_ccjson(path)
		self.nvim.out_write("The Path is included in compile_commands.json file. you can include files form that path!\n")
