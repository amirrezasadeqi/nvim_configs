...
let g:coc_global_extensions = ['coc-json', 'coc-lua', 'coc-clangd', 'coc-cmake', 'coc-pairs', 'coc-tasks', 'coc-snippets', 'coc-texlab', 'coc-sh', 'coc-marketplace', 'coc-python', 'coc-fzf-preview', 'coc-xml', 'coc-yaml']
